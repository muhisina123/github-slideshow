...
function para( content,content1,content2){   
 
document.write(content + content1+ content2 );

}

para("<p> first paragraph </p>","<p> second paragraph </p>","<p> third paragraph </p>");  
...
function calc( final_price){   
 sale==sale/100;

final_price=(sale/100)*price;
